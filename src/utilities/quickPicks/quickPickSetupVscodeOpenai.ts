...
export async function quickPickSetupVscodeOpenai(
  ...
  const title = "Configure Service Provider (syntax-by-ai)";
    ...
    const quickPickItemTypes: QuickPickItem[] = [
      {
        label: "$(github)  GitHub",
        description:
          "Use your github.com profile to sign into to syntax-by-ai service",
      },
      // {
      //   label: 'Microsoft',
      //   description:
      //     'Use microsoft profile to sign into to syntax-by-ai service',
      // },
    ];
