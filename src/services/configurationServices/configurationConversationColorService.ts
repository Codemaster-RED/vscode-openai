  ...
  implements IConfigurationConversationColor
{
  ...
  public get assistantBackgroundImage(): string {
    return this._isThemeDark()
      ? this.getConfigValue<string>(`${this._cfg}darkBackgroundImage`)
      : this.getConfigValue<string>(`${this._cfg}lightBackgroundImage`);
  }
  ...
  public static LogConfigurationService(): void {
    try {
      ...
      cfgMap.set("assistantBackgroundImage", cfg.assistantBackgroundImage);
