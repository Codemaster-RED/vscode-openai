// This file contains constants used throughout the syntax-by-ai extension.
...
export const VSCODE_OPENAI_EXTENSION = {
  ...
  ENABLED_COMMAND_ID: "syntax-by-ai.extension.enabled",
};
...
export const VSCODE_OPENAI_EMBEDDING = {
  ENABLED_COMMAND_ID: "syntax-by-ai.embedding.enabled",
  SETUP_REQUIRED_COMMAND_ID: "syntax-by-ai.embedding.setup-required",
